...
while($row = mysqli_fetch_array($result2)){
    echo "<tr><td>" . $row['id'] . "</td><td style=\"max-width:400px;overflow-wrap: break-word;\">" . $row['todotext'] . "</td><td>" . $row['color'] . "</td><td>" . $row['colortext'] . "</td><td>" . $row['textsize'] . "</td><td>" . $row['tododate'] . "</td><td>" . $row['mydate'] . "</td><td>" . $row['todouname'] . "</td><td>" . $row['done'] . "</td>";
